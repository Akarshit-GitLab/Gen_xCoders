      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            {isLogin ? "Welcome back to your digital wellness journey" : "Start your journey to mindful tech use"}
          </p>
        </div>
        ...
        <Card className="p-6 shadow-karma">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" variant="karma" className="w-full">
        ...
        <Card className="p-4 bg-gradient-primary shadow-glow">
          <div className="flex items-center gap-3 text-primary-foreground">
            ...
            <div className="flex-1">
              <div className="font-medium">Install Chrome Extension</div>
              <div className="text-sm text-primary-foreground/90">
                Get real-time tracking and AI coaching
              </div>
            </div>
